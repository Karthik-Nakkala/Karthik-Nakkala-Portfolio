      ...
      <div className='relative z-10 h-full w-full max-w-4xl mx-auto px-4 grid grid-cols-1 lg:grid-cols-2'>
        <div className='flex flex-col justify-center h-full text-center lg:text-left relative'>
          <div className='w-full lg:pr-12 mx-auto max-w-xl'>
            ...
            <a href='/karthik.fullstackdev.pdf' target='_blank' rel='noopener noreferrer' className='flex items-center gap-2 px-5 py-2 rounded-full text-base font-medium text-black bg-white hover:bg-gray-200 shadow-lg hover:scale-105 transition-all' download='Karthik_Nakkala_Resume.pdf'><FaDownload className="text-sm" /> My Resume</a>
            </motion.div>
